...
<div class="container">
        ...
        <a href="ins_form.php" class="btn btn-success">เพิ่มข้อมูลสิ้นค้า</a>
        <a href="ins_form.php" class="btn btn-success">เพิ่มข้อมูลประเภทสิ้นค้า</a>
        <a href="ins_form.php" class="btn btn-success">เพิ่มข้อมูลการขาย</a>
        <a href="ins_form.php" class="btn btn-success">เพิ่มข้อมูลพนักงาน</a>
        <a href="ins_form.php" class="btn btn-primary">logout</a>
